...
import { MdWork, MdGroup, MdLocationOn, MdLink, MdAdd } from "react-icons/md";
        ...
        <div className="shrink-0 bg-linear-to-r from-primary via-primary/90 to-secondary p-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h2 className="md:text-2xl text-lg font-bold text-white">Add New Career Opportunity</h2>
                <p className="text-white/80 text-sm mt-1">Create a new job posting</p>
              </div>
            </div>
            <button
              onClick={onClose}
