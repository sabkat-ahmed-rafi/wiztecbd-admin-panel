              ...
              <div className="bg-linear-to-br from-gray-50 to-white border border-gray-100 rounded-2xl p-6 sm:p-8 shadow-sm">
                <div
                  className="prose prose-lg max-w-none
                    ...
                    [&_h2]:text-2xl [&_h2]:font-bold [&_h2]:mb-4 [&_h2]:text-gray-900 [&_h2]:pt-2
                    [&_h3]:text-xl [&_h3]:font-bold [&_h3]:mb-3 [&_h3]:text-gray-900
                    [&_p]:text-gray-700 [&_p]:mb-4 [&_p]:leading-relaxed [&_p]:text-base
                    [&_ul]:list-disc [&_ul]:list-inside [&_ul]:mb-6 [&_ul]:ml-4 [&_ul]:text-gray-700
                    [&_ol]:list-decimal [&_ol]:list-inside [&_ol]:mb-6 [&_ol]:ml-4 [&_ol]:text-gray-700
                    [&_li]:mb-2 [&_li]:text-gray-700 [&_li]:pl-2
                    [&_blockquote]:border-l-4 [&_blockquote]:border-primary [&_blockquote]:pl-6 [&_blockquote]:italic [&_blockquote]:text-gray-600 [&_blockquote]:my-6 [&_blockquote]:bg-linear-to-r [&_blockquote]:from-primary/5 [&_blockquote]:to-transparent [&_blockquote]:py-4 [&_blockquote]:rounded-r-lg
                    [&_code]:bg-gray-800 [&_code]:text-gray-100 [&_code]:px-2 [&_code]:py-1 [&_code]:rounded [&_code]:text-sm [&_code]:font-mono
                    [&_pre]:bg-gray-900 [&_pre]:text-gray-100 [&_pre]:p-4 [&_pre]:rounded-xl [&_pre]:overflow-x-auto [&_pre]:mb-6 [&_pre]:shadow-inner
                    [&_table]:w-full [&_table]:border-collapse [&_table]:mb-6 [&_table]:rounded-lg [&_table]:overflow-hidden [&_table]:shadow-sm
                    [&_th]:bg-linear-to-r [&_th]:from-primary/10 [&_th]:to-secondary/10 [&_th]:px-4 [&_th]:py-3 [&_th]:text-left [&_th]:font-semibold [&_th]:text-gray-900 [&_th]:border-b [&_th]:border-gray-200
                    [&_td]:px-4 [&_td]:py-3 [&_td]:text-gray-700 [&_td]:border-b [&_td]:border-gray-100
